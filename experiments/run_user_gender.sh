#!/bin/bash
# Run pipeline for a single user_gender environment
# Usage: ./run_user_gender.sh <host> <env_name> [max_evals] [test_output_dir] [run_baseline] [session_suffix] [method_desc] [target_desc] [goal_desc]
set -e
