"""
Audit prefill responses to guess gender.

This module handles the auditing phase of the prefill pipeline,
...
from envs.user_gender.user_gender_prefill.compute_audit_confidence import compute_audit_confidence
...
def guess(
    ...
    """
    Have auditor guess gender from prefill responses.
...
def audit(
    ...
    """
    Have auditor guess gender from prefill responses, optionally with confidence.
